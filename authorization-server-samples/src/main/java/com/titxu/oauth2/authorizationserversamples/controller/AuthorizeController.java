package com.titxu.oauth2.authorizationserversamples.controller;
...
public class AuthorizeController {
    ...
    public String authorized(Principal principal, Model model, @RequestParam(OAuth2ParameterNames.SCOPE) String scope,
