...
-- ----------------------------
BEGIN;
INSERT INTO `config_info` VALUES (143, 'titxu-auth-server.yaml', 'DEFAULT_GROUP', 'server:\n  port: 8000\n\ndubbo:\n  application:\n    id: titxu-auth-server\n    name: titxu-auth-server\n    qosEnable: false\n  protocol:\n    name: dubbo\n    port: -1\n  registry:\n    address: nacos://localhost:8848\n    check: false\n  consumer.timeout: 30000\n  consumer.retries: 5\n\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    username: root\n    password: haoxin963\n    url: jdbc:mysql://localhost:3306/titxu-cloud?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai\n  redis:\n    host: localhost\n    port: 6379\n    password: titxu123\n    database: 0\n  cloud:\n    nacos:\n      discovery:\n        server-addr: localhost:8848\n    sentinel:\n      transport:\n        dashboard: localhost:5003', '442139ee1808af2f79ea2d2916eee9f9', '2021-06-25 21:20:35', '2021-06-25 21:20:35', NULL, '127.0.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL);
INSERT INTO `config_info` VALUES (144, 'titxu-gateway-server.yaml', 'DEFAULT_GROUP', 'server:\n  port: 10000\n\nspring:\n  redis:\n    host: localhost\n    port: 6379\n    password: titxu123\n    database: 0\n  security:\n    oauth2:\n      resourceserver:\n        jwt:\n          # 获取JWT验签公钥请求路径\n          jwk-set-uri: \'http://localhost:8000/getPublicKey\'\n  cloud:\n    nacos:\n      discovery:\n        server-addr: localhost:8848\n    sentinel:\n      transport:\n        dashboard: localhost:5003\n    gateway:\n      routes:\n      # 认证中心\n      - id: titxu-auth-server\n        uri: lb://titxu-auth-server\n        predicates:\n        - Path=/auth/**\n      # 用户\n      - id: titxu-sys-server\n        uri: lb://titxu-sys-server\n        predicates:\n        - Path=/sys/**\n      discovery:\n        locator:\n          enabled: true\n          lowerCaseServiceId: true\n\n# 配置白名单路径\nwhite-list:\n  urls:\n  - \"/auth/**\"\n  - \"/actuator/**\"\n  - \"/v2/api-docs/**\"\n  - \"/assets/**\"\n  - \"/sys/captcha\"\n  - \"/sys/register/**\"', '284387968a8c412b633977b5569c71be', '2021-06-25 21:21:41', '2021-06-25 21:21:41', NULL, '127.0.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL);
INSERT INTO `config_info` VALUES (145, 'titxu-server-sys.yaml', 'DEFAULT_GROUP', 'server:\n  port: 8101\n\ndubbo:\n  application:\n    id: titxu-sys-server\n    name: titxu-sys-server\n    qosEnable: false\n  registry:\n    address: nacos://localhost:8848\n    check: false\n  protocol:\n    name: dubbo\n    port: -1\n\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    username: root\n    password: haoxin963\n    url: jdbc:mysql://localhost:3306/titxu-cloud?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai\n  redis:\n    host: localhost\n    port: 6379\n    password: titxu123\n    database: 0\n  cloud:\n    nacos:\n      discovery:\n        server-addr: localhost:8848\n    sentinel:\n      transport:\n        dashboard: localhost:5003\n\n#mybatis\nmybatis-plus:\n  mapper-locations: classpath*:com/titxu/cloud/**/infrastructure/persistence/mapper/xml/*Mapper.xml\n  #实体扫描，多个package用逗号或者分号分隔\n  typeAliasesPackage: com.titxu.cloud.*.infrastructure.persistence.entity\n  global-config:\n    #数据库相关配置\n    db-config:\n      id-type: ASSIGN_ID\n      logic-delete-value: 1\n      logic-not-delete-value: 0\n      logic-delete-field: delFlag\n    banner: false\n  #原生配置\n  configuration:\n    map-underscore-to-camel-case: true\n    cache-enabled: false\n    call-setters-on-nulls: true\n    jdbc-type-for-null: \'null\'', '43c4743d70ca66b65549687bbc9e98c1', '2021-06-25 21:22:12', '2021-06-25 21:22:12', NULL, '127.0.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL);
COMMIT;
