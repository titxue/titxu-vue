<template>
    <div>
        <el-card>
            ...
            <Table :columns="tableColumn" :table-data="tableDataList" :options="options"
                @pagination-change="handlePaginationChange" @selection-change="handleSelection" @command="handleAction">
        ...
        <easy-dialog title="编辑用户" :fieldList="fieldList" :model="formData" @submit="handleBaseSubmit"
            @update:visible="recorddialogVisible" :visible="dialogVisible" :options="optionsDialog" @cancel="cancelEdit">
