...
import { PageUserInfoType, ReqUserCreateParams, ReqUserUpdateParams, ResultOkType, UserInfoType } from './types';
...
// 保存用户信息
const saveUserInfo = async (data: ReqUserCreateParams) => post<ResultOkType>({ url: URL.save, data });
...
// 获取用户列表
const getUserList = async (params?: PagingArgumentsType) => get<ResResultData<PageUserInfoType>>({ url: URL.list, params });
