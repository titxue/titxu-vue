      ...
      <transition name="el-zoom-in-center">
        <div class="icon-selector-box">
          <div class="selector-header">
            <div class="selector-title">{{ title ? title : 'select an icon' }}</div>
            <div class="selector-tab">
              <span title="'Element Puls Icon" @click="onChangeTab('ele')" :class="state.iconType === 'ele' ? 'active' : ''">ele</span>
              <span title="Font Awesome Icon" @click="onChangeTab('awe')" :class="state.iconType === 'awe' ? 'active' : ''">awe</span>
              <span title="iconcont Icon" @click="onChangeTab('ali')" :class="state.iconType === 'ali' ? 'active' : ''">ali</span>
              <span title="utils.Local icon title" @click="onChangeTab('local')" :class="state.iconType === 'local' ? 'active' : ''"
                >local</span
              >
            </div>
          </div>
