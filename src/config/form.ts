...
export const exampleForm = {
  ...
  editUser: [
    ...
    { label: '角色列表', field: 'roleIdList', type: 'select', options: { data: [{ label: '吃饭', value: 1 }, { label: '睡觉', value: 2 }, { label: '写代码', value: 3 }] } },
    { label: '状态', field: 'status',type: 'radio', options: { data: [{ label: '有效', value: '0' }, { label: '禁用', value: '1' }] } },
  ],
  customkeyForm: [
    { label: '标题', field: 'name' },
