...
import type { xTableApi } from '/@/api/common';
...
import { PageResultType } from '../api/types';

export default class xTable<T> {
  // API实例
  ...
  constructor(api: xTableApi, table: XTable, form: XTableForm = {}, before: XTableBefore = {}, after: XTableAfter = {}) {
    this.api = api;
